...
@interface ONEArticleView : UIView <WKNavigationDelegate, UITableViewDelegate, UITableViewDataSource>
...
@property (nonatomic, strong) ONEContentTableViewCell *articleCell;
